        ...
        const sampleExperiences = [
            {
                ...
                end_date: '至今',
                current: 1,
                description: '负责部门销售业绩BI看板搭建和维护，为管理层和部门经理提供数据支持。负责海外部门的月度、季度、年度产品数据销售情况分析，从品类、大区、价格、部门等多维度下钻分析并输出分析报告，为管理层提供数据支持。',
                achievements: 'BI看板搭建|月度/季度/年度销售数据分析报告（800+次）|海关外部数据挖掘市场增长点|CIFF展会竞品调研PPT|库存周转指标体系搭建|累计处理数据80000+条|整理维护产品资料50000+条|翻译产品中文信息3000+|荣获闪耀新星奖项|荣获最佳赋能人员奖'
            }
        ];
        ...
        const sampleEducation = [
            {
                ...
                end_date: '2025.06',
                gpa: 'GPA 4.16/5',
                description: '经济统计学专业，系统学习统计学、经济学、数据分析等课程。主修课程：统计学原理、计量经济学、应用多元统计分析、Python数据分析、时间序列分析、概率论与数理统计、机器学习。'
            }
        ];
